    ...
    <div class="p-8 w-full space-y-8">
        ...
        <div class="mb-8 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <form action="<?php echo e(route('planner.auto-hermes')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white border border-neutral-200 rounded-lg p-6 shadow-sm">
                ...
                <form action="<?php echo e(route('planner.store')); ?>" method="POST" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <div>
            ...
            <div class="lg:col-span-2 space-y-4">
                <div class="flex items-center justify-between pb-3 border-b border-neutral-200">
                    ...
                    <span class="text-xs text-neutral-500"><?php echo e(count($plans)); ?> Draf Konten</span>
                </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="bg-white border border-neutral-200 rounded-lg p-5 shadow-sm hover:border-neutral-400 transition">
                            <div class="flex items-start justify-between mb-3">
                                <div>
                                    <div class="flex items-center space-x-2 mb-1">
                                        <span class="text-xs font-bold text-neutral-900"><?php echo e($plan->title); ?></span>
                                        <span class="text-[10px] bg-neutral-100 text-neutral-700 px-2 py-0.5 rounded uppercase font-mono"><?php echo e($plan->media_type); ?></span>
                                    </div>
                                    <p class="text-xs text-neutral-500">Tone: <strong class="text-neutral-800 capitalize"><?php echo e($plan->tone); ?></strong> | Jadwal: <?php echo e($plan->scheduled_at ? $plan->scheduled_at->format('d M Y, H:i') : 'Draft'); ?></p>
                                </div>

                                <!-- SPK SAW Score Badge -->
                                <div class="text-right">
                                    <div class="inline-flex items-center px-2.5 py-1 rounded text-xs font-bold font-mono <?php echo e($plan->spk_score >= 80 ? 'bg-emerald-100 text-emerald-800 border border-emerald-200' : ($plan->spk_score >= 60 ? 'bg-amber-100 text-amber-800 border border-amber-200' : 'bg-rose-100 text-rose-800 border border-rose-200')); ?>">
                                        Skor SPK: <?php echo e($plan->spk_score); ?>/100
                                    </div>
                                    <div class="text-[10px] font-semibold mt-1 uppercase tracking-wider <?php echo e($plan->spk_score >= 80 ? 'text-emerald-600' : ($plan->spk_score >= 60 ? 'text-amber-600' : 'text-rose-600')); ?>">
                                        🌟 <?php echo e($plan->priority_level); ?>
                            ...
                            <div class="bg-neutral-50 p-3.5 rounded border border-neutral-100 text-xs text-neutral-700 whitespace-pre-line leading-relaxed mb-3">
                                <?php echo e($plan->caption); ?>

                            </div>

                            <!-- Action Buttons -->
                            <div class="flex items-center justify-between pt-2 border-t border-neutral-100 text-xs">
                                <span class="text-[11px] text-neutral-400">Status: <strong class="text-neutral-700 uppercase"><?php echo e($plan->status); ?></strong></span>
                                <form action="<?php echo e(route('planner.destroy', $plan->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/resources/views/planner.blade.php ENDPATH**/ ?>