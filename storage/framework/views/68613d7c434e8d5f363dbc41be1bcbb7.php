...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" class="text-xs font-medium text-neutral-600 hover:text-neutral-900 transition flex items-center space-x-1">
            ...
            <div class="mt-4 pt-2">
                <?php if($account): ?>
                    <div class="flex items-center justify-between bg-neutral-50 p-4 rounded border border-neutral-200">
                        <div>
                            <p class="text-xs font-semibold text-neutral-800">@ <?php echo e($account->username); ?></p>
                            <p class="text-xs text-neutral-500 mt-0.5">Account ID: <?php echo e($account->instagram_account_id); ?></p>
                        </div>
                        <form action="<?php echo e(route('instagram.disconnect')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                ...
                <?php else: ?>
                    <div class="text-center py-4">
                        ...
                        <a href="<?php echo e(route('instagram.connect')); ?>" class="inline-flex items-center px-4 py-2 bg-neutral-900 hover:bg-neutral-800 text-white text-xs font-medium uppercase tracking-wider rounded transition">
                            Connect Instagram
                        </a>
                    </div>
                <?php endif; ?>
        ...
        <div class="bg-white border border-neutral-200 rounded-lg p-6 shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                <div class="p-4 bg-neutral-50 rounded border border-neutral-200">
                    ...
                    <span class="font-mono text-neutral-800 font-semibold mt-1 block"><?php echo e($config['instagram_client_id'] ?? 'Not Configured'); ?></span>
                </div>
                <div class="p-4 bg-neutral-50 rounded border border-neutral-200">
                    <span class="text-neutral-500 font-medium block">OpenAI API Key</span>
                    <span class="font-mono text-neutral-800 font-semibold mt-1 block"><?php echo e($config['openai_api_key']); ?></span>
                </div>
                <div class="p-4 bg-neutral-50 rounded border border-neutral-200">
                    <span class="text-neutral-500 font-medium block">Environment Mode</span>
                    <span class="font-semibold text-neutral-800 mt-1 block uppercase"><?php echo e(app()->environment()); ?></span>
                </div>
                <div class="p-4 bg-neutral-50 rounded border border-neutral-200">
                    <span class="text-neutral-500 font-medium block">Mock Mode Status</span>
                    <span class="font-semibold <?php echo e($config['instagram_mock_mode'] ? 'text-amber-600' : 'text-emerald-600'); ?> mt-1 block uppercase">
                        <?php echo e($config['instagram_mock_mode'] ? 'Enabled (Demo Mode)' : 'Disabled (Live API)'); ?>
        ...
        <div class="bg-white border border-neutral-200 rounded-lg p-6 shadow-sm">
            ...
            <form action="<?php echo e(route('settings.update')); ?>" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="agency_name" id="agency_name" value="<?php echo e($user->name ?? 'Agency Admin'); ?>" class="w-full max-w-md px-3 py-2 border border-neutral-300 rounded text-xs focus:ring-1 focus:ring-neutral-900 focus:outline-none">
                </div>
...
<?php endif; ?>
<?php /**PATH /var/www/resources/views/settings.blade.php ENDPATH**/ ?>