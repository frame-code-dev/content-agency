    ...
    <div class="p-8 w-full space-y-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div class="bg-white border border-zinc-200 rounded-[10px] p-6 shadow-sm">
                ...
                <div class="mt-4 flex items-baseline justify-between">
                    <span class="text-2xl font-bold font-heading text-zinc-950 tracking-tight">{{ $insights['top_age_bracket'] ?? '25-34 Years' }}</span>
            ...
            <div class="bg-white border border-zinc-200 rounded-[10px] p-6 shadow-sm">
                ...
                <div class="mt-4 flex items-baseline justify-between">
                    <span class="text-3xl font-bold font-heading text-zinc-950 tracking-tight">{{ number_format($insights['followers_count'] ?? 2850) }}</span>
                ...
                <div class="space-y-4">
                    <div>
                        <div class="flex justify-between text-xs font-bold text-zinc-700 mb-1">
                            ...
                            <span>{{ $insights['female_pct'] ?? '58.2%' }}</span>
                        </div>
                        <div class="w-full bg-zinc-100 h-3 rounded-full overflow-hidden">
                            <div class="bg-zinc-950 h-full" style="width: {{ $insights['female_pct'] ?? '58.2%' }}"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex justify-between text-xs font-bold text-zinc-700 mb-1">
                            ...
                            <span>{{ $insights['male_pct'] ?? '41.8%' }}</span>
                        </div>
                        <div class="w-full bg-zinc-100 h-3 rounded-full overflow-hidden">
                            <div class="bg-zinc-500 h-full" style="width: {{ $insights['male_pct'] ?? '41.8%' }}"></div>
                        </div>
                    </div>
                </div>
            </div>
