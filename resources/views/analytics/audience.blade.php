            ...
            <div class="bg-white border border-slate-200/80 rounded-3xl p-6 shadow-sm">
                ...
                <div class="space-y-3 font-mono">
                    <div class="flex items-center space-x-3 text-xs font-semibold">
                        <span class="w-16 text-slate-500">18-24</span>
                        <div class="flex-1 bg-slate-100 h-7 rounded-xl overflow-hidden relative">
                            <div class="bg-slate-300 h-full rounded-xl" style="width: 35%"></div>
                            <span class="absolute right-3 top-1.5 text-[11px] font-bold text-slate-700">35%</span>
                        </div>
                    </div>

                    <div class="flex items-center space-x-3 text-xs font-semibold">
                        <span class="w-16 text-slate-900 font-bold">25-34</span>
                        <div class="flex-1 bg-slate-100 h-7 rounded-xl overflow-hidden relative">
                            <div class="bg-slate-900 h-full rounded-xl" style="width: 52%"></div>
                            <span class="absolute right-3 top-1.5 text-[11px] font-bold text-[#A3E635]">52%</span>
                        </div>
                    </div>

                    <div class="flex items-center space-x-3 text-xs font-semibold">
                        <span class="w-16 text-slate-500">35-44</span>
                        <div class="flex-1 bg-slate-100 h-7 rounded-xl overflow-hidden relative">
                            <div class="bg-slate-300 h-full rounded-xl" style="width: 13%"></div>
                            <span class="absolute right-3 top-1.5 text-[11px] font-bold text-slate-700">13%</span>
                        </div>
                    </div>
                </div>
            </div>
