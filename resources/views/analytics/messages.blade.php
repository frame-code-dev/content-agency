<x-app-layout>
    <div class="p-8 w-full space-y-8">
        ...
        <div class="bg-white border border-slate-200/70 rounded-3xl p-8 text-center shadow-sm max-w-3xl mx-auto my-6">
            ...
            <div class="mt-6">
                <a href="{{ route('instagram.connect') }}" class="inline-flex items-center space-x-2 px-8 py-3.5 bg-[#072215] text-[#A3E635] text-xs font-bold rounded-2xl shadow hover:scale-105 transition">
