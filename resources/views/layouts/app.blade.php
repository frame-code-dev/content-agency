...
<head>
    ...
    <title>{{ config('app.name', 'Cineart Production - Media & AI Studio') }}</title>
            ...
            <div>
                ...
                <nav class="px-4 py-6 space-y-6 overflow-y-auto max-h-[calc(100vh-160px)] custom-scrollbar">
                    ...
                    <div>
                        ...
                        <div class="space-y-1">
                            <a href="{{ route('dashboard') }}" class="flex items-center space-x-3 px-3.5 py-2.5 rounded-[10px] font-semibold text-xs transition duration-150 {{ request()->routeIs('dashboard') ? 'bg-white text-zinc-950 shadow-md' : 'text-zinc-300 hover:bg-zinc-900 hover:text-white' }}">
                            ...
                            @if($hasConnectedAccount)
                                <a href="{{ route('analytics.content') }}" class="flex items-center space-x-3 px-3.5 py-2.5 rounded-[10px] font-semibold text-xs transition duration-150 {{ request()->routeIs('analytics.content') ? 'bg-white text-zinc-950 shadow-md' : 'text-zinc-300 hover:bg-zinc-900 hover:text-white' }}">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="{{ route('analytics.engagement') }}" class="flex items-center space-x-3 px-3.5 py-2.5 rounded-[10px] font-semibold text-xs transition duration-150 {{ request()->routeIs('analytics.engagement') ? 'bg-white text-zinc-950 shadow-md' : 'text-zinc-300 hover:bg-zinc-900 hover:text-white' }}">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="{{ route('analytics.reach') }}" class="flex items-center space-x-3 px-3.5 py-2.5 rounded-[10px] font-semibold text-xs transition duration-150 {{ request()->routeIs('analytics.reach') ? 'bg-white text-zinc-950 shadow-md' : 'text-zinc-300 hover:bg-zinc-900 hover:text-white' }}">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="{{ route('analytics.audience') }}" class="flex items-center space-x-3 px-3.5 py-2.5 rounded-[10px] font-semibold text-xs transition duration-150 {{ request()->routeIs('analytics.audience') ? 'bg-white text-zinc-950 shadow-md' : 'text-zinc-300 hover:bg-zinc-900 hover:text-white' }}">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            @else
                                <a href="{{ route('instagram.connect') }}" class="flex items-center justify-between px-3.5 py-2.5 rounded-[10px] font-semibold text-xs text-zinc-600 hover:bg-zinc-900/50 transition duration-150 group">
                    ...
                    <div>
                        ...
                        <div class="space-y-1">
                            @if($hasConnectedAccount)
                                <a href="{{ route('campaigns.index') }}" class="flex items-center space-x-3 px-3.5 py-2.5 rounded-[10px] font-semibold text-xs transition duration-150 {{ request()->routeIs('campaigns.*') ? 'bg-white text-zinc-950 shadow-md' : 'text-zinc-300 hover:bg-zinc-900 hover:text-white' }}">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        <div class="space-y-1">
                            @if($hasConnectedAccount)
                                <a href="{{ route('planner.index') }}" class="flex items-center space-x-3 px-3.5 py-2.5 rounded-[10px] font-semibold text-xs transition duration-150 {{ request()->routeIs('planner.*') ? 'bg-white text-zinc-950 shadow-md' : 'text-zinc-300 hover:bg-zinc-900 hover:text-white' }}">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                    </svg>
                                    <span>Post Scheduler</span>
                                </a>
                                <a href="{{ route('messages.index') }}" class="flex items-center space-x-3 px-3.5 py-2.5 rounded-[10px] font-semibold text-xs transition duration-150 {{ request()->routeIs('messages.*') ? 'bg-white text-zinc-950 shadow-md' : 'text-zinc-300 hover:bg-zinc-900 hover:text-white' }}">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        <div class="space-y-1">
                            @if($hasConnectedAccount)
                                <a href="{{ route('competitors.index') }}" class="flex items-center space-x-3 px-3.5 py-2.5 rounded-[10px] font-semibold text-xs transition duration-150 {{ request()->routeIs('competitors.*') ? 'bg-white text-zinc-950 shadow-md' : 'text-zinc-300 hover:bg-zinc-900 hover:text-white' }}">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        <div class="space-y-1">
                            <a href="{{ route('settings') }}" class="flex items-center space-x-3 px-3.5 py-2.5 rounded-[10px] font-semibold text-xs transition duration-150 {{ request()->routeIs('settings') ? 'bg-white text-zinc-950 shadow-md' : 'text-zinc-300 hover:bg-zinc-900 hover:text-white' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="p-4 border-t border-zinc-800/80 bg-zinc-950">
                ...
                <div class="flex items-center justify-between p-2.5 rounded-[10px] bg-zinc-900 border border-zinc-800">
                    <div class="flex items-center space-x-3 truncate">
                        @if(!empty($avatarUrl))
                            <img src="{{ $avatarUrl }}" alt="{{ $displayName }}" class="w-8 h-8 rounded-[10px] object-cover border border-zinc-700">
                        @else
                        ...
                        <div class="truncate">
                            ...
                            <div class="text-[10px] text-zinc-400 truncate">{{ $displaySub }}</div>
                        </div>
                    </div>
                    @if(auth()->check())
